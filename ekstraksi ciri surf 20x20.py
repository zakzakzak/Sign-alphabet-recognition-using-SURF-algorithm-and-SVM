...
if __name__ == '__main__':
    ...
    for kk in range(20,24):
        ...
        np.savetxt("dataset_semua/" + orang + "/csv1/" + alphabet[kk] + " (" + str(k) + ").csv", arr_feat1, delimiter=",")
        # cv2.imshow('huruf ' + alphabet[kk] + " " + str(k + 1), arr_p[k][1])

        k = 1
        arr_feat1 = np.array(arr_p[k])[0]
        np.savetxt("dataset_semua/" + orang + "/csv1/" + alphabet[kk] + " (" + str(k) + ").csv", arr_feat1,
                   delimiter=",")
        # cv2.imshow('huruf ' + alphabet[kk] + " " + str(k + 1), arr_p[k][1])
