...
def separate(arr):
    ...
    for i in range(4):
        for j in range(4):
            arr2.append(arr[i * 20:(i + 1) * 20, j * 20:(j + 1) * 20])
...
def feature_n_draw(list15x15, img):
    ...
    for i in range(len(list15x15)):
        # print(len(list15x15))
        crop1 = img[list15x15[i][0] - 40:list15x15[i][0] + 40, list15x15[i][1] - 40:list15x15[i][1] + 40]
...
# region Description : char dataset
'''-------------------------------------------------'''
alphabet = []
alphabet.append('a')
alphabet.append('b')
...
# Matching instan
# gambar2 = "bluimg2/b.jpg"

if __name__ == '__main__':
    list_data = []
    # for aaa in range(11):
    p = Pool(2)
    for lop in range(8,9):
        orang = "orang"+str(lop+1)

        for kk in range(2,3):
            print(orang + ' huruf ' + alphabet[kk])
            k = 0
            gambar0 = "dataset_semua/" + orang + "/" + alphabet[kk] + " (" + str(k + 1) + ").jpg"
            print("proses huruf " + str(alphabet[kk]) + " ke-" + str(k + 1))

            k = 1
            gambar1 = "dataset_semua/" + orang + "/" + alphabet[kk] + " (" + str(k + 1) + ").jpg"
            print("proses huruf " + str(alphabet[kk]) + " ke-" + str(k + 1))
            k = 2
            gambar2 = "dataset_semua/" + orang + "/" + alphabet[kk] + " (" + str(k + 1) + ").jpg"
            print("proses huruf " + str(alphabet[kk]) + " ke-" + str(k + 1))
            k = 3
            gambar3 = "dataset_semua/" + orang + "/" + alphabet[kk] + " (" + str(k + 1) + ").jpg"
            print("proses huruf " + str(alphabet[kk]) + " ke-" + str(k + 1))
            k = 4
            gambar4 = "dataset_semua/" + orang + "/" + alphabet[kk] + " (" + str(k + 1) + ").jpg"
            print("proses huruf " + str(alphabet[kk]) + " ke-" + str(k + 1))
            k = 5
            gambar5 = "dataset_semua/" + orang + "/" + alphabet[kk] + " (" + str(k + 1) + ").jpg"
            print("proses huruf " + str(alphabet[kk]) + " ke-" + str(k + 1))


            arr_p = p.map(proses_feature, [gambar0, gambar1, gambar2, gambar3, gambar4, gambar5])
            print(np.array(arr_p[0]).shape)

            k = 0
            arr_feat1 = np.array(arr_p[k])[0]
            np.savetxt("dataset_semua/" + orang + "/csv2/" + alphabet[kk] + " (" + str(k) + ").csv", arr_feat1, delimiter=",")
            # cv2.imshow('huruf ' + alphabet[kk] + " " + str(k + 1), arr_p[k][1])

            k = 1
            arr_feat1 = np.array(arr_p[k])[0]
            np.savetxt("dataset_semua/" + orang + "/csv2/" + alphabet[kk] + " (" + str(k) + ").csv", arr_feat1,
                       delimiter=",")
            # cv2.imshow('huruf ' + alphabet[kk] + " " + str(k + 1), arr_p[k][1])
            ...
            # arr_feat1 = np.array(arr_feat1)
            # np.savetxt("dataset_semua/" + orang + "/csv/" + alphabet[kk] + " (" + str(k) + ").csv", arr_feat1, delimiter=",")
            # cv2.imshow('huruf ' + alphabet[kk] + " " + str(k + 1), img1)
            #
            # k = 1
            # gambar1 = "dataset_semua/" + orang + "/" + alphabet[kk] + " (" + str(k + 1) + ").jpg"
            # print("proses huruf " + str(alphabet[kk]) + " ke-" + str(k + 1))
            # arr_feat1, img1 = proses_feature(gambar1, kk)
            # arr_feat1 = np.array(arr_feat1)
            # np.savetxt("dataset_semua/" + orang + "/csv/" + alphabet[kk] + " (" + str(k) + ").csv", arr_feat1, delimiter=",")
            # cv2.imshow('huruf ' + alphabet[kk] + " " + str(k + 1), img1)
            #
...
# for k in range(6):
#     kk = k + 1
#     gambar1 = "coba/1 (" + str(kk) + ").jpg"
#     # gambar1 = "bluimg2/kedua/" + alphabet[k] + ".jpg"
#     # alphabet[k]
#     print("proses huruf " + str(alphabet[k]))
#     # arr_feat1, arr_feat2, img1, img2, tambahan = matching_instan(gambar1, gambar2)
#     arr_feat1, img1 = proses_feature(gambar1, k)
#     # print(arr_feat1)
#     arr_feat1 = np.array(arr_feat1)
#     # np.savetxt("bluimg2/csv_kujeng/data"+str(k)+".csv", arr_feat1, delimiter=",")
#     # np.savetxt("bluimg2/csvx/data" + str(k) + ".csv", arr_feat1, delimiter=",")
#     # list_data.append(arr_feat1)
#     cv2.imshow('huruf ' + alphabet[k], img1)
#
#     # print(arr_feat1)
#     print("________________________")

# list_data = np.array(list_data)
# np.savetxt("foo.csv", list_data, delimiter=",")
cv2.waitKey(0)
cv2.destroyAllWindows()
